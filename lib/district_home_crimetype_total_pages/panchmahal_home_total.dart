...
class PanchmahalHome extends StatelessWidget {
  const PanchmahalHome({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Center(
          ...
          child: Column(
            ...
            children: [
              Image.asset('assets/maps/panchmahal-removebg-preview.png'),
              MaterialButton(
                onPressed: () {
      ...
      appBar: AppBar(
        title: Text('Panchmahal Total Crime'),
