...
class SabarkanthaHome extends StatelessWidget {
  const SabarkanthaHome({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Center(
          ...
          child: Column(
            ...
            children: [
              Image.asset(
                  'assets/maps/sabarkantha-removebg-preview-removebg-preview.png'),
              MaterialButton(
                onPressed: () {
      ...
      appBar: AppBar(
        title: Text('Sabarkantha Total Crime'),
