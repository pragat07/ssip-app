...
class VadodaraHome extends StatelessWidget {
  const VadodaraHome({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Center(
          ...
          child: Column(
            ...
            children: [
              Image.asset('assets/maps/Vadodara-removebg-preview.png'),
              MaterialButton(
                onPressed: () {
      ...
      appBar: AppBar(
        title: Text('Vadodara Total Crime'),
