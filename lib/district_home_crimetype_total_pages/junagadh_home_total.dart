...
class JunagadhHome extends StatelessWidget {
  const JunagadhHome({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Center(
          ...
          child: Column(
            ...
            children: [
              Image.asset('assets/maps/junagadh-removebg-preview.png'),
              MaterialButton(
                onPressed: () {
      ...
      appBar: AppBar(
        title: Text('Junagadh Total Crime'),
