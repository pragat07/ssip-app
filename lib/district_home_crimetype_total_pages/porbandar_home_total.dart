...
class PorbandarHome extends StatelessWidget {
  const PorbandarHome({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Center(
          ...
          child: Column(
            ...
            children: [
              Image.asset('assets/maps/probandar-removebg-preview.png'),
              MaterialButton(
                onPressed: () {
      ...
      appBar: AppBar(
        title: Text('Porbandar Total Crime'),
